...
export const SubscriptionOutlineIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      enableBackground="new 0 0 24 24"
...
export const FashionAndBeautyIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
  ...
  return (
    ...
    >
      <mask
        ...
        height="70"
      >
        <path d="M47 -23H-23V47H47V-23Z" fill="white" />
      </mask>
      <g mask="url(#mask0_80_2)">
        <mask
          ...
          height="35"
        >
          <path d="M-4.86401 -5.38525H28.9849V28.4636H-4.86401V-5.38525Z" fill="white" />
        </mask>
        <g mask="url(#mask1_80_2)">
          <path
            d="M2.3501 20.1769L2.34282 10.8145L3.81859 10.811L3.80949 20.1736L2.3501 20.1769Z"
            fill="white"
            stroke="white"
            stroke-width="0.79"
          />
          <path
            d="M4.21398 10.415L1.94751 10.4204L1.95541 20.5728L4.2041 20.5677L4.21398 10.415Z"
            fill="white"
            stroke="white"
            stroke-width="0.79"
          />
          <path
            d="M19.0699 10.4098L13.7009 10.4124L15.1172 5.05662C15.4608 3.95089 15.6777 2.52952 14.5477 2.5188C13.9852 2.51344 13.4211 2.51344 13.1452 2.79326L6.3712 10.121L6.36133 20.5732L17.9275 20.5622C19.0654 20.5622 19.4008 19.8785 19.6261 18.8695L21.0292 12.6754C21.3192 11.3443 20.5835 10.4098 19.0699 10.4098Z"
            fill="white"
          />
          <path
            d="M19.0699 10.4098L13.7009 10.4124L15.1172 5.05662C15.4608 3.95089 15.6777 2.52952 14.5477 2.5188C13.9852 2.51344 13.4211 2.51344 13.1452 2.79326L6.3712 10.121L6.36133 20.5732L17.9275 20.5622C19.0654 20.5622 19.4008 19.8785 19.6261 18.8695L21.0292 12.6754C21.3192 11.3443 20.5835 10.4098 19.0699 10.4098Z"
...
export const ShareOutlinedIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
